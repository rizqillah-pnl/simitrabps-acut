...
if ($result1['Id_jabatan'] == "1") :
    ...
    $data = mysqli_query($conn, "SELECT * FROM lowongan WHERE deleted=0 LIMIT $awalData, $jumlahDataPerHalaman");
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php if ($result1['Id_jabatan'] == 1) {  ?>
                            <li class="sidebar-item" style="background-color: #1a9bfc; border-radius: 9px"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="lowongan.php" aria-expanded="false"><i class="mdi mdi-file-document-box text-white"></i><span class="hide-menu text-white">Daftar Survei</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid mb-5">
                <div class="row">
                    <div class="col-lg">
                        <div class="mb-0">
                            <button type="button" class="btn btn-primary text-white text-center mb-2" data-bs-toggle="modal" data-bs-target="#TambahLowongan"><i class="mdi mdi-account-plus"></i> Tambah
                                Survei</button>
                        </div>
                    </div>
                            ...
                            <?php if (mysqli_num_rows($data) != 0) : ?>
                                <?php foreach ($data as $row) : ?>
                                    <tr class="text-start">
                                        ...
                                        <td class="row">
                                            <div class="col" style="padding-left: 0; padding-right:0; margin-left: 0; margin-right:0;">
