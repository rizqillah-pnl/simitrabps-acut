...
<body class="h-100">
                ...
                <div class="pt-2 pb-3 mx-auto">
                    <form method="POST" style="width: 350px;" action="../model/login.php" class="mx-auto" autocomplete="off">
                        ...
                        <div class="d-grid gap-2 mb-3">
                            <button type="submit" class="btn btn-block btn-primary text-center" disabled name="submit" id="login">
                                <i class="fa-solid fa-arrow-right-to-bracket"></i> Login
                            </button>
                        </div>
                        <div class="d-grid gap-2 mx-auto">
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#Registrasi"><i class="fa-solid fa-file-lines"></i>
                                Registrasi</button>
                        </div>
                    </form>
                </div>
    ...
    <!-- Footer -->
    <div id="footer" class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-2 px-4 px-xl-5">
                ...
                <div class="modal-body">
                    <form method="POST" action="../model/tambah-user.php" class="mx-auto" autocomplete="off">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" name="register" class="btn btn-primary"><i class="fa-solid fa-file-lines"></i> Daftar</button>
                        </div>
                    </form>
                </div>
