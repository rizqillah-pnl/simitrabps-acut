            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item" style="background-color: #1a9bfc; border-radius: 9px"> <a
                            class="sidebar-link waves-effect waves-dark sidebar-link" href="lowongan-user.php"
                            aria-expanded="false"><i class="mdi mdi-worker text-white"></i><span
                                class="hide-menu text-white">Survei Terdaftar</span></a></li>
        ...
        <div class="modal fade " id="Detail<?= $row['id']; ?>" tabindex="-1" aria-labelledby="DetailLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center><img src="../public/img/assets/<?= $row['gambar']; ?>" alt="gambar lowongan"
