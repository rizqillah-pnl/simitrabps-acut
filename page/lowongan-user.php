...
$jumData = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) FROM tb_lowongan_user WHERE tb_lowongan_user.id_petugas='$kode'"));
$jumlahHalaman = ceil($jumData['COUNT(*)'] / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET['page'])) ? $_GET['page'] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;


$data = mysqli_query($conn, "SELECT a.Kode_petugas, a.Username, a.Email, a.Password, a.Old_password, a.Last_login, a.Created_at, a.Updated_at, b.Nama, b.NIK, b.Alamat, b.Foto, b.NoHP, b.Tanggal_lahir, b.Tempat_lahir, c.Jabatan, c.Id_jabatan FROM auth a, petugas b, jabatan c WHERE a.Kode_petugas=b.Kode_petugas AND b.Jabatan=c.Id_jabatan AND a.deleted=0 ORDER BY b.Jabatan, a.Last_login DESC LIMIT $awalData, $jumlahDataPerHalaman");
...
<head>
    <title>Survei Terdaftar | Simitra Aceh Utara</title>
        ...
        <div class="scroll-sidebar" id="navbar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item" style="background-color: #1a9bfc; border-radius: 9px"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="lowongan-user.php" aria-expanded="false"><i class="mdi mdi-worker text-white"></i><span class="hide-menu text-white">Survei Terdaftar</span></a></li>
        ...
        <div class="page-breadcrumb" style="padding-bottom: 0; padding-top: 0;">
            <div class="row align-items-center">
                <div class="col-6">
                    ...
                    <h1 class="mb-0 fw-bold">Survei Terdaftar</h1>
                </div>
                <div class="col-6">
        ...
        <div class="container-fluid mb-4">
            <div class="table-responsive" id="container">
                <table class="table table-hover align-middle text-nowrap">
                    ...
                    <?php $no = $awalData; ?>
                    <tbody>
                        <?php $lowongan = mysqli_query($conn, "SELECT tb_lowongan_user.id, tb_lowongan_user.id_lowongan, tb_lowongan_user.id_petugas, tb_lowongan_user.tanggal_daftar, tb_lowongan_user.id_kec, tb_lowongan_user.L_action, lowongan.jenis_lowongan, lowongan.tanggal_mulai, lowongan.tanggal_akhir, lowongan.persyaratan, lowongan.deskripsi, lowongan.gambar, tb_kecamatan.nama_kec FROM tb_lowongan_user LEFT JOIN lowongan ON lowongan.id=tb_lowongan_user.id_lowongan LEFT JOIN tb_kecamatan ON tb_kecamatan.id=tb_lowongan_user.id_kec WHERE tb_lowongan_user.id_petugas='$kode' ORDER BY tb_lowongan_user.id DESC LIMIT $awalData, $jumlahDataPerHalaman"); ?>
                        <?php if (mysqli_num_rows($lowongan) != 0) : ?>
                            <?php foreach ($lowongan as $row) : ?>
                                <tr class="text-start">
                                    ...
                                    <td class="text-center text-dark" style="padding-bottom: 0; padding-top: 0;">
                                        <?php if ($row['L_action'] == "1") : ?>
                                            <div class="text-center text-success fw-bold">Diterima</div>
                                        <?php elseif ($row['L_action'] == "2") : ?>
                                            <div class="text-center text-danger fw-bold">Ditolak</div>
                                        <?php else : ?>
                                            <div class="text-center text-warning fw-bold">Pending</div>
                                        <?php endif; ?>
                                    </td>
                                    <!-- 
                                ...
                                <div class="row" style="padding-right: 0; padding-left: 0;">
                                    <button type="button" class="btn btn-danger mt-1 text-white text-center"
                                        data-bs-toggle="modal" data-bs-target="#Delete<?= $row['id']; ?>"> <i
                                            class="mdi mdi-account-remove"></i> Hapus</button>
                                </div>
                            </td> -->
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <td class="text-center text-secondary fw-bold" colspan="6">
                                ...
                                <p style="font-size: 15px;">Belum Mendaftar Survei! <a href="index.php">Daftar Disini</a>
                                </p>
                            </td>
                        <?php endif; ?>
                    </tbody>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="../model/delete-lowongan-user.php" method="POST">
                                    <input type="hidden" name="url" value="lowongan-user.php">
