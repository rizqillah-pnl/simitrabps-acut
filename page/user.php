                                ...
                                <tr class="text-start">
                                    ...
                                    <td class="row" style="padding-bottom: 0; padding-top: 0;">
                                        <div class="col" style="padding: 0; margin: 0;">
                                            <button type="button" class="btn btn-success mt-1 text-center  text-white" data-bs-toggle="modal" data-bs-target="#Detail<?= $row['Kode_petugas']; ?>"><i class="mdi mdi-eye"></i></button>
                                        </div>
                                        <?php if ($result1['Kode_petugas'] != $row['Kode_petugas']) : ?>
                                            <div class="col" style="padding: 0; margin: 0;">
                                                <button type="button" class="btn btn-warning mt-1 text-center" data-bs-toggle="modal" data-bs-target="#Edit<?= $row['Kode_petugas']; ?>"><i class="mdi mdi-pencil"></i></button>
                                            </div>
                                            <div class="col" style="padding: 0; margin: 0;">
                                                <button type="button" class="btn btn-danger mt-1 text-white text-center" data-bs-toggle="modal" data-bs-target="#Delete<?= $row['Kode_petugas']; ?>"> <i class="mdi mdi-account-remove"></i></button>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                            ...
                            <form action="../model/edit-user.php" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="username" class="form-control" id="user" value="<?= $row['Username']; ?>" oninput="this.value = this.value.toLowerCase()" maxlength="25">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
